        ...
        <div class="modal-dialog vertical-align-center">
                        <div class="modal-content">
                           <div class="modal-header">
							   <!--<div class="modal-header-tag">Exclusivo Itaú</div>-->
...
<!--        <div class='container'>
        ...
        <nav class='bottom-links'>
         <!-- <span>Copyright © 2016 Restorando</span>
          ...
          <a href="http://buenos-aires.restorando.com.ar/pages/terms" target="_blank" style="text-decoration:underline!important;">Términos y Condiciones</a>
